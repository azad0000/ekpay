...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.ipn.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.ipns.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('txn_id_no') ? 'is-invalid' : '' }}" name="txn_id_no_id" id="txn_id_no_id" required>
                    @foreach($txn_id_nos as $id => $entry)
                        <option value="{{ $id }}" {{ old('txn_id_no_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('msg_code') ? 'is-invalid' : '' }}" type="text" name="msg_code" id="msg_code" value="{{ old('msg_code', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('msg_det') ? 'is-invalid' : '' }}" name="msg_det" id="msg_det" required>{{ old('msg_det') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('req_timestamp') ? 'is-invalid' : '' }}" type="text" name="req_timestamp" id="req_timestamp" value="{{ old('req_timestamp') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dgtl_sign') ? 'is-invalid' : '' }}" type="text" name="dgtl_sign" id="dgtl_sign" value="{{ old('dgtl_sign', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ekpay_txn_id_no') ? 'is-invalid' : '' }}" type="text" name="ekpay_txn_id_no" id="ekpay_txn_id_no" value="{{ old('ekpay_txn_id_no', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pi_trnx_id_no') ? 'is-invalid' : '' }}" type="text" name="pi_trnx_id_no" id="pi_trnx_id_no" value="{{ old('pi_trnx_id_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pi_charge') ? 'is-invalid' : '' }}" type="text" name="pi_charge" id="pi_charge" value="{{ old('pi_charge', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ekpay_charge') ? 'is-invalid' : '' }}" type="text" name="ekpay_charge" id="ekpay_charge" value="{{ old('ekpay_charge', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pi_discount') ? 'is-invalid' : '' }}" type="text" name="pi_discount" id="pi_discount" value="{{ old('pi_discount', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_ser_charge') ? 'is-invalid' : '' }}" type="text" name="total_ser_charge" id="total_ser_charge" value="{{ old('total_ser_charge', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ekpay_charge_discount') ? 'is-invalid' : '' }}" type="text" name="ekpay_charge_discount" id="ekpay_charge_discount" value="{{ old('ekpay_charge_discount', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('promo_discount') ? 'is-invalid' : '' }}" type="text" name="promo_discount" id="promo_discount" value="{{ old('promo_discount', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_pabl_amt') ? 'is-invalid' : '' }}" type="text" name="total_pabl_amt" id="total_pabl_amt" value="{{ old('total_pabl_amt', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('pay_timestamp') ? 'is-invalid' : '' }}" type="text" name="pay_timestamp" id="pay_timestamp" value="{{ old('pay_timestamp') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pi_name') ? 'is-invalid' : '' }}" type="text" name="pi_name" id="pi_name" value="{{ old('pi_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pi_type') ? 'is-invalid' : '' }}" type="text" name="pi_type" id="pi_type" value="{{ old('pi_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pi_number') ? 'is-invalid' : '' }}" type="text" name="pi_number" id="pi_number" value="{{ old('pi_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pi_gateway') ? 'is-invalid' : '' }}" type="text" name="pi_gateway" id="pi_gateway" value="{{ old('pi_gateway', '') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Ipn::IS_SETTLED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('is_settled') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="is_settled_{{ $key }}" name="is_settled" value="{{ $key }}" {{ old('is_settled', '1') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('settlement') ? 'is-invalid' : '' }}" type="text" name="settlement" id="settlement" value="{{ old('settlement', '') }}">
