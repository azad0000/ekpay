        ...
        <form method="POST" action="{{ route("admin.companies.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('has_ekpay_id_no') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="has_ekpay_id_no" id="has_ekpay_id_no" value="1" {{ old('has_ekpay_id_no', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mer_reg') ? 'is-invalid' : '' }}" type="text" name="mer_reg" id="mer_reg" value="{{ old('mer_reg', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mer_pas_key') ? 'is-invalid' : '' }}" type="text" name="mer_pas_key" id="mer_pas_key" value="{{ old('mer_pas_key', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('domain_url') ? 'is-invalid' : '' }}" type="text" name="domain_url" id="domain_url" value="{{ old('domain_url', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('s_uri') ? 'is-invalid' : '' }}" type="text" name="s_uri" id="s_uri" value="{{ old('s_uri', '') }}">
                @if($errors->has('s_uri'))
                    <div class="invalid-feedback">
                        {{ $errors->first('s_uri') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('f_uri') ? 'is-invalid' : '' }}" type="text" name="f_uri" id="f_uri" value="{{ old('f_uri', '') }}">
                @if($errors->has('f_uri'))
                    <div class="invalid-feedback">
                        {{ $errors->first('f_uri') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('c_uri') ? 'is-invalid' : '' }}" type="text" name="c_uri" id="c_uri" value="{{ old('c_uri', '') }}">
                @if($errors->has('c_uri'))
                    <div class="invalid-feedback">
                        {{ $errors->first('c_uri') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('ipn_channel') ? 'is-invalid' : '' }}" name="ipn_channel" id="ipn_channel" required>
                    ...
                    @foreach(App\Models\Company::IPN_CHANNEL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('ipn_channel', '0') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ipn_email') ? 'is-invalid' : '' }}" type="text" name="ipn_email" id="ipn_email" value="{{ old('ipn_email', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ipn_uri') ? 'is-invalid' : '' }}" type="text" name="ipn_uri" id="ipn_uri" value="{{ old('ipn_uri', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mac_addr') ? 'is-invalid' : '' }}" type="text" name="mac_addr" id="mac_addr" value="{{ old('mac_addr', '') }}">
