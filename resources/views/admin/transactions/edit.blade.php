    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.transactions.update", [$transaction->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_id_no') ? 'is-invalid' : '' }}" type="text" name="cust_id_no" id="cust_id_no" value="{{ old('cust_id_no', $transaction->cust_id_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_name') ? 'is-invalid' : '' }}" type="text" name="cust_name" id="cust_name" value="{{ old('cust_name', $transaction->cust_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_mobo_no') ? 'is-invalid' : '' }}" type="text" name="cust_mobo_no" id="cust_mobo_no" value="{{ old('cust_mobo_no', $transaction->cust_mobo_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_email') ? 'is-invalid' : '' }}" type="email" name="cust_email" id="cust_email" value="{{ old('cust_email', $transaction->cust_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cust_mail_addr') ? 'is-invalid' : '' }}" type="text" name="cust_mail_addr" id="cust_mail_addr" value="{{ old('cust_mail_addr', $transaction->cust_mail_addr) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('merchant_trnx_id_no') ? 'is-invalid' : '' }}" type="text" name="merchant_trnx_id_no" id="merchant_trnx_id_no" value="{{ old('merchant_trnx_id_no', $transaction->merchant_trnx_id_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('merchant_trnx_amt') ? 'is-invalid' : '' }}" type="text" name="merchant_trnx_amt" id="merchant_trnx_amt" value="{{ old('merchant_trnx_amt', $transaction->merchant_trnx_amt) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Transaction::TRNX_CURRENCY_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('trnx_currency') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="trnx_currency_{{ $key }}" name="trnx_currency" value="{{ $key }}" {{ old('trnx_currency', $transaction->trnx_currency) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('merchant_ord_id_no') ? 'is-invalid' : '' }}" type="text" name="merchant_ord_id_no" id="merchant_ord_id_no" value="{{ old('merchant_ord_id_no', $transaction->merchant_ord_id_no) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('merchant_ord_det') ? 'is-invalid' : '' }}" name="merchant_ord_det" id="merchant_ord_det">{{ old('merchant_ord_det', $transaction->merchant_ord_det) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('company') ? 'is-invalid' : '' }}" name="company_id" id="company_id" required>
                    @foreach($companies as $id => $entry)
                        <option value="{{ $id }}" {{ (old('company_id') ? old('company_id') : $transaction->company->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
