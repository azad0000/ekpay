    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.generals.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mer_reg_id_no') ? 'is-invalid' : '' }}" type="text" name="mer_reg_id_no" id="mer_reg_id_no" value="{{ old('mer_reg_id_no', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mer_pas_key') ? 'is-invalid' : '' }}" type="text" name="mer_pas_key" id="mer_pas_key" value="{{ old('mer_pas_key', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ekpay_dev_uri') ? 'is-invalid' : '' }}" type="text" name="ekpay_dev_uri" id="ekpay_dev_uri" value="{{ old('ekpay_dev_uri', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ekpay_prod_uri') ? 'is-invalid' : '' }}" type="text" name="ekpay_prod_uri" id="ekpay_prod_uri" value="{{ old('ekpay_prod_uri', '') }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('test_mode') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="test_mode" id="test_mode" value="1" {{ old('test_mode', 0) == 1 ? 'checked' : '' }}>
                    <label class="required form-check-label" for="test_mode">{{ trans('cruds.general.fields.test_mode') }}</label>
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('s_uri') ? 'is-invalid' : '' }}" type="text" name="s_uri" id="s_uri" value="{{ old('s_uri', '') }}" required>
                @if($errors->has('s_uri'))
                    <div class="invalid-feedback">
                        {{ $errors->first('s_uri') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('f_uri') ? 'is-invalid' : '' }}" type="text" name="f_uri" id="f_uri" value="{{ old('f_uri', '') }}" required>
                @if($errors->has('f_uri'))
                    <div class="invalid-feedback">
                        {{ $errors->first('f_uri') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('c_uri') ? 'is-invalid' : '' }}" type="text" name="c_uri" id="c_uri" value="{{ old('c_uri', '') }}" required>
                @if($errors->has('c_uri'))
                    <div class="invalid-feedback">
                        {{ $errors->first('c_uri') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ipn_uri') ? 'is-invalid' : '' }}" type="text" name="ipn_uri" id="ipn_uri" value="{{ old('ipn_uri', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mac_addr') ? 'is-invalid' : '' }}" type="text" name="mac_addr" id="mac_addr" value="{{ old('mac_addr', '1.1.1.1') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('ipn_channel') ? 'is-invalid' : '' }}" name="ipn_channel" id="ipn_channel" required>
                    ...
                    @foreach(App\Models\General::IPN_CHANNEL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('ipn_channel', '3') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ipn_email') ? 'is-invalid' : '' }}" type="email" name="ipn_email" id="ipn_email" value="{{ old('ipn_email') }}" required>
