<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('ipn_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.ipns.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/ipns") || request()->is("admin/ipns/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">

                    </i>
                    {{ trans('cruds.ipn.title') }}
                </a>
            </li>
        @endcan
        ...
        @endcan
        @can('setting_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/generals*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
